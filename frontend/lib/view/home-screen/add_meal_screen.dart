...
class _AddMealScreenState extends State<AddMealScreen> {
  ...
  void _calculateTotals() {
    ...
    for (var food in selectedFoods) {
      final quantity =
          int.tryParse(quantityControllers[food.foodId]?.text ?? '1') ?? 1;
      calories += (food.caloriesPerUnit ?? 0) * quantity;
      carbs += (food.carbsPerUnit ?? 0) * quantity;
      protein += (food.proteinPerUnit ?? 0) * quantity;
      fat += (food.fatPerUnit ?? 0) * quantity;
    }
